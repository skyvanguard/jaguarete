...
export const CommonZh: Resources['translation'] = {
  ...
  data_center_desc: 'Jaguarete支持数据库交互和基于文档的对话，它还提供了一个用户友好的数据中心管理界面。',
  ...
  jaguarete_community: 'Jaguarete社区',
  community_jaguarete: '社区Jaguarete',
  my_jaguarete: '我的Jaguarete',
  Refresh_jaguarete: '从社区Git仓库刷新',
  workflow: '工作流',
  resources: '资源',
  app: '应用',
  ...
  home_title: 'Jaguarete - Purple Team 平台',
