...
export const ChatZh: Resources['translation'] = {
  ...
  jaguarete_computer: 'Jaguarete 的电脑',
  load_skill: '加载技能',
  ...
  jaguarete_thinking: 'Jaguarete 正在思考 ···',
  replay_badge: '回放',
  replay_page_title: 'Jaguarete 对话回放',
  replay_page_title_with_question: '{{question}} · Jaguarete 回放',
