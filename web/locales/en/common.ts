export const CommonEn = {
  ...
  data_center_desc:
    'Jaguarete also offers a user-friendly data center management interface for efficient data maintenance.',
  ...
  jaguarete_community: 'Jaguarete Community',
  community_jaguarete: 'Community Jaguarete',
  my_jaguarete: 'My Jaguarete',
  Refresh_jaguarete: 'Refresh from the community Git repository',
  workflow: 'Workflow',
  resources: 'Resources',
  app: 'App',
  ...
  home_title: 'Jaguarete - Purple Team Platform',
