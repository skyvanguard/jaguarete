    ...
    (content: UserChatContent, data?: Record<string, any>) => {
      return new Promise<void>(resolve => {
        ...
        if (scene !== 'chat_dashboard') {
          const finalPromptCode = selectedPromptCodeRef.current || localStorage.getItem(`jaguarete_prompt_code_${chatId}`);
          if (finalPromptCode) {
            apiData.prompt_code = finalPromptCode;
            localStorage.removeItem(`jaguarete_prompt_code_${chatId}`);
          }
        }
          ...
          <Layout className='bg-transparent'>
            ...
            <PromptBot
              submit={prompt => {
                ...
                if (scene === 'chat_dashboard') {
                  localStorage.setItem(`jaguarete_prompt_code_${chatId}`, prompt.prompt_code);
                } else {
