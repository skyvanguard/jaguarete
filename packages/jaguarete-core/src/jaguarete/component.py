"""Component module for jaguarete.
...
from jaguarete.util import AppConfig
from jaguarete.util.annotations import PublicAPI
...
class ComponentType(str, Enum):
    WORKER_MANAGER = "jaguarete_worker_manager"
    WORKER_MANAGER_FACTORY = "jaguarete_worker_manager_factory"
    MODEL_CONTROLLER = "jaguarete_model_controller"
    MODEL_REGISTRY = "jaguarete_model_registry"
    MODEL_API_SERVER = "jaguarete_model_api_server"
    MODEL_CACHE_MANAGER = "jaguarete_model_cache_manager"
    PLUGIN_HUB = "jaguarete_plugin_hub"
    MULTI_AGENTS = "jaguarete_multi_agents"
    EXECUTOR_DEFAULT = "jaguarete_thread_pool_default"
    TRACER = "jaguarete_tracer"
    TRACER_SPAN_STORAGE = "jaguarete_tracer_span_storage"
    RAG_GRAPH_DEFAULT = "jaguarete_rag_engine_default"
    AWEL_TRIGGER_MANAGER = "jaguarete_awel_trigger_manager"
    AWEL_DAG_MANAGER = "jaguarete_awel_dag_manager"
    UNIFIED_METADATA_DB_MANAGER_FACTORY = "jaguarete_unified_metadata_db_manager_factory"
    CONNECTOR_MANAGER = "jaguarete_connector_manager"
    RAG_STORAGE_MANAGER = "jaguarete_rag_storage_manager"
    AGENT_MANAGER = "jaguarete_agent_manager"
    RESOURCE_MANAGER = "jaguarete_resource_manager"
    SKILL_MANAGER = "jaguarete_skill_manager"
    VARIABLES_PROVIDER = "jaguarete_variables_provider"
    FILE_STORAGE_CLIENT = "jaguarete_file_storage_client"
    BENCHMARK_DATA_MANAGER = "jaguarete_benchmark_data_manager"
...
class SystemApp(LifeCycle):
    ...
    def _build(self):
        ...
        if not self.app:
            ...
            return
        from jaguarete.util.fastapi import register_event_handler
