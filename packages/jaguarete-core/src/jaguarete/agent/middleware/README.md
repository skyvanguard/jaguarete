...
This module implements a middleware system for Jaguarete agents, inspired by deepagents' AgentMiddleware pattern.
...
| Feature | DeepAgents | Jaguarete (New) |
|---------|-------------|----------------|
...
If you're using `SkillsAgent` from `jaguarete.agent.skill.agent`, you can migrate to `MiddlewareAgent`:
...
This module is part of Jaguarete and follows the same license.
