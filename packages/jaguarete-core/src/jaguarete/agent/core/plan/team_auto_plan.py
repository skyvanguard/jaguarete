...
class AutoPlanChatManager(ManagerAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "AutoPlanChatManager",
            category="agent",
            key="jaguarete_agent_plan_team_auto_plan_profile_name",
        ),
        role=DynConfig(
            "PlanManager",
            category="agent",
            key="jaguarete_agent_plan_team_auto_plan_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="jaguarete_agent_plan_team_auto_plan_profile_goal",
        ),
        desc=DynConfig(
            "Advance the task plan generated by the planning agent.",
            category="agent",
            key="jaguarete_agent_plan_team_auto_plan_profile_desc",
        ),
    )
