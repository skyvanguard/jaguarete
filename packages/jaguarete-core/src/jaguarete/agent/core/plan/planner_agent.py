...
from jaguarete._private.pydantic import Field
...
class PlannerAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "Planner",
            category="agent",
            key="jaguarete_agent_plan_planner_agent_profile_name",
        ),
        role=DynConfig(
            "Planner",
            category="agent",
            key="jaguarete_agent_plan_planner_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="jaguarete_agent_plan_planner_agent_profile_goal",
        ),
        expand_prompt=DynConfig(
            "Available Intelligent Agents:\n {{ agents }}",
            category="agent",
            key="jaguarete_agent_plan_planner_agent_profile_expand_prompt",
        ),
...
assistants:[
    ...
    {{
        ...
        "rely": "1,2"
            ...
            category="agent",
            key="jaguarete_agent_plan_planner_agent_profile_examples",
        ),
    )
    _goal_zh: str = (
