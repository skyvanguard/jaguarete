...
from jaguarete._private.config import Config
...
from jaguarete.core.awel.dag.dag_manager import DAGManager
...
class AWELBaseManager(ManagerAgent, ABC):
    ...
    profile: ProfileConfig = ProfileConfig(
        ...
        role=DynConfig(
            "PlanManager", category="agent", key="jaguarete_agent_plan_awel_profile_name"
        ),
        goal=DynConfig(
            "Promote and solve user problems according to the process arranged "
            "by AWEL.",
            category="agent",
            key="jaguarete_agent_plan_awel_profile_goal",
        ),
        desc=DynConfig(
            "Promote and solve user problems according to the process arranged "
            "by AWEL.",
            category="agent",
            key="jaguarete_agent_plan_awel_profile_desc",
        ),
    )
