...
from jaguarete.core import LLMClient
...
def _agent_resource_prompt_values() -> List[OptionValue]:
    # jaguarete_serve was removed; return empty list as fallback
    return []
...
@register_resource(
    ...
    alias=[
        "jaguarete.serve.agent.team.layout.agent_operator_resource.AwelAgentResource",
        "jaguarete.agent.core.plan.awel.agent_operator_resource.AWELAgentResource",
    ],
)
...
def _agent_resource_knowledge_values(
    ...
    # jaguarete_app was removed; return empty list as fallback
    return []
...
@register_resource(
    ...
    alias=[
        "jaguarete.serve.agent.team.layout.agent_operator_resource.AwelAgentKnowledgeResource",  # noqa
        "jaguarete.agent.core.plan.awel.agent_operator_resource.AWELAgentKnowledgeResource",
    ],
)
...
@register_resource(
    ...
    alias=[
        "jaguarete.serve.agent.team.layout.agent_operator_resource.AgentPrompt",
        "jaguarete.agent.core.plan.awel.agent_operator_resource.AgentPrompt",
    ],
)
...
@register_resource(
    ...
    alias=[
        "jaguarete.serve.agent.team.layout.agent_operator_resource.AwelAgentConfig",
        "jaguarete.agent.core.plan.awel.agent_operator_resource.AWELAgentConfig",
    ],
)
...
@register_resource(
    ...
    alias=[
        "jaguarete.serve.agent.team.layout.agent_operator_resource.AwelAgent",
        "jaguarete.agent.core.plan.awel.agent_operator_resource.AWELAgent",
    ],
)
