...
from jaguarete.util.annotations import immutable, mutable
...
class HybridMemory(Memory, Generic[T]):
    ...
    def from_chroma(
        ...
        **kwargs,
        ...
        Requires jaguarete_ext package for ChromaStore.
        """
        from jaguarete.configs.model_config import DATA_DIR
        ...
        try:
            ...
            raise ImportError(
                "ChromaStore requires the jaguarete_ext package. "
                "Install it or use from_vstore() with a custom vector store."
            )
