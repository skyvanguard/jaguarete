...
from jaguarete._private.pydantic import ConfigDict, Field
from jaguarete.core import LLMClient, ModelMessageRoleType, PromptTemplate
from jaguarete.util.error_types import LLMChatError
from jaguarete.util.executor_utils import blocking_func_to_async
from jaguarete.util.tracer import SpanType, root_tracer
from jaguarete.util.utils import colored
...
class ConversableAgent(Role, Agent):
    ...
    def bind(self, target: Any) -> "ConversableAgent":
        ...
        # claude_skill module was removed
        ...
        if FileBasedSkill is not None and isinstance(target, FileBasedSkill):
            try:
                from jaguarete.agent.skill.base import Skill, SkillMetadata, SkillType
        ...
        try:
            ...
            from jaguarete.agent.skill.base import SkillBase
