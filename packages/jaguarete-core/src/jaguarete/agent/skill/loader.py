...
class SkillLoader:
    ...
    def _load_from_markdown(self, path: Path) -> Optional[Skill]:
        ...
        NOTE: claude_skill module was removed; this method is currently disabled.
        """
        try:
            raise ImportError("claude_skill module was removed")

            file_skill = None  # type: ignore[unreachable]
