...
from typing import Any, Dict, Generic, List, Optional, Protocol, Tuple, Union

import cachetools

from jaguarete.util.cache_utils import cached
...
class RDBMSConnectorProtocol(Protocol):
    """Protocol for RDBMS connectors (datasource module was removed)."""
...
class RDBMSConnectorResource(DBResource[DBParameters]):
    ...
    def get_schema_link(
        ...
        raise NotImplementedError(
            "get_schema_link requires jaguarete_ext.rag.summary which was removed."
        )
