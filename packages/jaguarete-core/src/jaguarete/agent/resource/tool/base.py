...
from jaguarete._private.pydantic import BaseModel, Field, model_validator
from jaguarete.util.configure.base import _MISSING, _MISSING_TYPE
from jaguarete.util.function_utils import parse_param_description, type_to_string
...
JAGUARETE_TOOL_IDENTIFIER = "jaguarete_tool"
    ...
    *decorator_args: Union[str, Callable],
    ...
    def _create_decorator(name: str):
        def decorator(func: ToolFunc):
            ...
            setattr(wrapper, JAGUARETE_TOOL_IDENTIFIER, True)
            return wrapper
