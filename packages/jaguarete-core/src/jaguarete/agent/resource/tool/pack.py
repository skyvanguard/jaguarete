...
from jaguarete.util.json_utils import parse_or_raise_error
...
from .base import JAGUARETE_TOOL_IDENTIFIER, BaseTool, FunctionTool, ToolFunc
...
def _is_function_tool(resources: Any) -> bool:
    return (
        callable(resources)
        and hasattr(resources, JAGUARETE_TOOL_IDENTIFIER)
        and getattr(resources, JAGUARETE_TOOL_IDENTIFIER)
