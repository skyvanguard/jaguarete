...
from jaguarete.agent.core.schema import Status
from jaguarete.util.json_utils import serialize
from jaguarete.util.sql_utils import remove_sql_comments
from jaguarete.util.string_utils import extract_content, extract_content_open_ending
...
class ApiCall:
    ...
    def to_view_text(self, api_status: PluginStatus):
        """Return the view content."""
        api_call_element = ET.Element("jaguarete-view")
