...
from jaguarete.component import ComponentType, SystemApp
from jaguarete.configs.model_config import resolve_root_path
from jaguarete.util.i18n_utils import _
from jaguarete.util.module_utils import import_from_checked_string
from jaguarete.util.parameter_utils import BaseParameters
from jaguarete.util.tracer.base import (
    Span,
    SpanStorage,
    SpanStorageType,
    SpanType,
...
from jaguarete.util.tracer.span_storage import MemorySpanStorage
...
class TracerParameters(BaseParameters):
    ...
    file: Optional[str] = field(
        ...
        metadata={
            "help": _(
                "The file to store the tracer, e.g. jaguarete_webserver_tracer.jsonl"
            ),
        },
    )
...
def initialize_tracer(
    tracer_filename: str,
    root_operation_name: str = "Jaguarete-Webserver",
    ...
    from jaguarete.util.tracer.span_storage import FileSpanStorage, SpanStorageContainer
    ...
    if tracer_parameters and tracer_parameters.exporter == "telemetry":
        from jaguarete.util.tracer.opentelemetry import OpenTelemetrySpanStorage
    ...
    if system_app.app:
        from jaguarete.util.tracer.tracer_middleware import TraceIDMiddleware
