...
from jaguarete.configs.model_config import LOGDIR
from jaguarete.util.tracer import SpanType, SpanTypeRunName

logger = logging.getLogger("jaguarete_cli")


_DEFAULT_FILE_PATTERN = os.path.join(LOGDIR, "jaguarete*.jsonl")
