...
from jaguarete.util.speech.base import VoiceBase
from jaguarete.util.speech.brian import BrianSpeech
from jaguarete.util.speech.eleven_labs import ElevenLabsSpeech
from jaguarete.util.speech.gtts import GTTSVoice
from jaguarete.util.speech.macos_tts import MacOSTTS
