...
from jaguarete.core.awel import TransformStreamAbsOperator
...
from jaguarete.core.interface.llm import ModelOutput
from jaguarete.core.operators import BaseLLM
from jaguarete.util.chat_util import transform_to_sse
...
async def _to_openai_stream(
    ...
    from jaguarete.core.schema.api import (
