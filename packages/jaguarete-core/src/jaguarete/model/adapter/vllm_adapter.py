...
from jaguarete.core import ModelMessage
from jaguarete.core.interface.parameter import LLMDeployModelParameters
from jaguarete.model.adapter.base import LLMModelAdapter, register_model_adapter
from jaguarete.model.adapter.model_metadata import COMMON_HF_MODELS
...
from jaguarete.util.parameter_utils import (
...
class VLLMModelAdapterWrapper(LLMModelAdapter):
    ...
    def __init__(self, conv_factory: Optional[ConversationAdapterFactory] = None):
        if not conv_factory:
            from jaguarete.model.adapter.model_adapter import (
    ...
    def get_async_generate_stream_function(
        ...
        from jaguarete.model.llm.llm_out.vllm_llm import generate_stream
