...
from jaguarete.core.interface.parameter import LLMDeployModelParameters
from jaguarete.model.adapter.base import LLMModelAdapter, get_model_adapter
from jaguarete.model.adapter.template import ConversationAdapter, ConversationAdapterFactory
from jaguarete.model.base import ModelType

logger = logging.getLogger(__name__)

thread_local = threading.local()
_IS_BENCHMARK = os.getenv("JAGUARETE_MODEL_BENCHMARK", "False").lower() == "true"
...
def get_llm_model_adapter(
    ...
    if use_fastchat:
        ...
        from jaguarete.model.adapter.fschat_adapter import (
...
def _dynamic_model_parser() -> Optional[List[Type[LLMDeployModelParameters]]]:
    ...
    """
    from jaguarete.model.adapter.base import get_embedding_adapter
    from jaguarete.model.parameter import WorkerType
    from jaguarete.util.parameter_utils import _SimpleArgParser
