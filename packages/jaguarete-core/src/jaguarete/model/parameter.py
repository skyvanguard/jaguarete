...
from jaguarete.util.configure.manager import RegisterParameters


@dataclass
class BaseDatasourceParameters:
    """Stub for datasource parameters (datasource module was removed)."""
...
class ModelWorkerParameters(BaseServerParameters):
    ...
    worker_class: Optional[str] = field(
        default=None,
        metadata={
            "help": _("Model worker class, jaguarete.model.cluster.DefaultModelWorker")
        },
    )
