...
We have integrated fastchat. For details, see: jaguarete/model/model_adapter.py
"""
...
from jaguarete.model.utils.llm_utils import is_partial_stop, is_sentence_complete
