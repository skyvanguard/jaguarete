...
_OLD_AGENT_OPERATOR_MODULE = "jaguarete.serve.agent.team.layout.agent_operator"
_NEW_AGENT_OPERATOR_MODULE = "jaguarete.agent.core.plan.awel.agent_operator"

_OLD_AGENT_RESOURCE_MODULE_1 = "jaguarete.serve.agent.team.layout.agent_operator_resource"
_OLD_AGENT_RESOURCE_MODULE_2 = "jaguarete.agent.plan.awel.agent_operator_resource"
_NEW_AGENT_RESOURCE_MODULE = "jaguarete.agent.core.plan.awel.agent_operator_resource"
...
def _register_flow_compat(
    ...
    # For example, jaguarete.core.DefaultLLMOperator may be refactor to
    # jaguarete_ext.DefaultLLMOperator, so we use DefaultLLMOperator as the key
...
def get_new_class_name(old_class_name: str) -> Optional[str]:
    ...
    from jaguarete import __version__
...
_register(
    "jaguarete.storage.vector_store.connector",
    "jaguarete.serve.rag.connector",
