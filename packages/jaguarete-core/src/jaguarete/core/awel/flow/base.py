...
from jaguarete._private.pydantic import (
    BaseModel,
    ConfigDict,
    Field,
    ValidationError,
...
from jaguarete.core.awel.util.parameter_util import (
    BaseDynamicOptions,
    OptionValue,
    RefreshOptionRequest,
)
from jaguarete.core.interface.serialization import Serializable
from jaguarete.util.executor_utils import DefaultExecutorFactory, blocking_func_to_async
from jaguarete.util.i18n_utils import LazyTranslatedString
...
class BaseMetadata(BaseResource):
    ...
    documentation_url: Optional[str] = Field(
        ...
        examples=["https://docs.jaguarete.site/docs/awel"],
    )
    ...
    id: str = Field(
        ...
        examples=[
            ...
            "resource_jaguarete.model.proxy.llms.chatgpt.OpenAILLMClient",
        ],
    )
...
class ResourceMetadata(BaseMetadata, TypeMetadata):
    ...
    parent_cls: List[str] = Field(
        ...
        examples=[
            "jaguarete.core.interface.llm.LLMClient",
            "resource_jaguarete.model.proxy.llms.chatgpt.OpenAILLMClient",
        ],
    )
...
def auto_register_resource(
    ...
    **decorator_kwargs,
    ...
    from jaguarete.util.function_utils import TYPE_STRING_TO_TYPE
    from jaguarete.util.parameter_utils import _get_parameter_descriptions
...
class ViewMetadata(BaseMetadata):
    ...
    type_cls: Optional[str] = Field(
        ...
        examples=["jaguarete.model.operators.LLMOperator"],
    )
