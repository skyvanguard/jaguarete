...
from jaguarete._private.pydantic import BaseModel, Field, model_to_dict, model_validator
...
class UIUpload(UIComponent):
    ...
    action: Optional[str] = Field(
        "/api/v2/serve/file/files/jaguarete",
        description="The URL for the file upload(default bucket is 'jaguarete')",
    )
