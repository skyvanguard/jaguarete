...
from jaguarete.core.awel import (
    DAG,
    BaseOperator,
    InputOperator,
    JoinOperator,
...
from jaguarete.core.awel.trigger.http_trigger import CommonLLMHttpRequestBody
from jaguarete.core.interface.llm import ModelRequest
from jaguarete.core.interface.message import MessageStorageItem, StorageConversation
from jaguarete.core.interface.operators.llm_operator import (
    MergedRequestBuilderOperator,
    RequestBuilderOperator,
)
from jaguarete.core.interface.operators.message_operator import (
    BufferedConversationMapperOperator,
    PreChatHistoryLoadOperator,
)
from jaguarete.core.interface.operators.prompt_operator import HistoryPromptBuilderOperator
from jaguarete.core.interface.prompt import ChatPromptTemplate
...
class ConversationComposerOperator(MapOperator[CommonLLMHttpRequestBody, ModelRequest]):
    ...
    def _build_composer_dag(self):
        with DAG("jaguarete_awel_chat_history_prompt_composer") as composer_dag:
