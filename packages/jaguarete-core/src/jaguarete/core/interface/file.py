...
from jaguarete.util.tracer import root_tracer, trace
...
class FileStorageClient(BaseComponent):
    ...
    def __init__(
        ...
        if not storage_system:
            ...
            base_path = Path.home() / ".cache" / "jaguarete" / "files"
    ...
    def download_file(
        ...
        if dest_path:
            ...
            base_path = str(Path.home() / ".cache" / "jaguarete" / "files")
