...
from jaguarete._private.pydantic import model_validator
from jaguarete.core import ModelMessage, ModelOutput, StorageConversation
from jaguarete.core.awel import JoinOperator, MapOperator
...
from jaguarete.core.interface.message import BaseMessage
from jaguarete.core.interface.operators.llm_operator import BaseLLM
from jaguarete.core.interface.operators.message_operator import BaseConversationOperator
from jaguarete.core.interface.prompt import (
...
from jaguarete.util.function_utils import rearrange_args_by_type
...
class PromptBuilderOperator(
    ...
    Examples:
        .. code-block:: python
            ...
            from jaguarete.core.operators import PromptBuilderOperator
