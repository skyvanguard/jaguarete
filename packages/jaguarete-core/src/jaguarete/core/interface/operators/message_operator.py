...
from jaguarete.core.awel import BaseOperator, MapOperator
...
class PreChatHistoryLoadOperator(
    ...
    In Jaguarete, conversation record and the messages in the conversation are stored in
    the storage,
...
class BufferedConversationMapperOperator(ConversationMapperOperator):
    ...
    Examples:
        .. code-block:: python
            ...
            import asyncio
            from jaguarete.core.interface.message import AIMessage, HumanMessage
            from jaguarete.core.operators import BufferedConversationMapperOperator
    ...
    def _filter_round_messages(
        ...
        Examples:
            >>> from jaguarete.core import AIMessage, HumanMessage
            >>> from jaguarete.core.operators import BufferedConversationMapperOperator
            >>> messages = [
            ...     [
            ...         HumanMessage(content="Hi", round_index=1),
