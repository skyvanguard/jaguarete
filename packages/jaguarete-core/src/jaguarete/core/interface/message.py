...
from jaguarete._private.pydantic import BaseModel, Field, model_to_dict
from jaguarete.core.interface.media import MediaContent
...
class ModelMessage(BaseModel):
    """Type of message that interaction between jaguarete-server and llm-server."""
...
def _append_view_messages(messages: List[BaseMessage]) -> List[BaseMessage]:
    ...
    Just for show in Jaguarete-Web.
