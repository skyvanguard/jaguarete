...
def test_md_header_text_splitter() -> None:
    ...
    expected_output = [
        Chunk(
            content='"jaguarete-description": my name is jaguarete',
            metadata={"Header 1": "jaguarete", "Header 2": "description"},
        ),
        Chunk(
            content='"jaguarete-content": my name is aries',
            metadata={"Header 1": "jaguarete", "Header 2": "content"},
        ),
    ]
