...
from jaguarete.core import Chunk, LLMClient, ModelMessageRoleType, ModelRequest
from jaguarete.rag.extractor.base import Extractor
from jaguarete.util import utils
...
class SummaryExtractor(Extractor):
    ...
    async def _aextract(self, chunks: List[Chunk]) -> str:
        ...
        from jaguarete.util.prompt_util import PromptHelper
