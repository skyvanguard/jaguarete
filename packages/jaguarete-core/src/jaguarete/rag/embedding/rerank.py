...
from jaguarete.configs.model_config import get_device
from jaguarete.core import RerankEmbeddings
from jaguarete.core.interface.parameter import RerankerDeployModelParameters
...
class QwenRerankEmbeddings(BaseModel, RerankEmbeddings):
    ...
    .. code-block:: python
        from jaguarete.rag.embedding.rerank import QwenRerankEmbeddings
