...
from jaguarete._private.pydantic import EXTRA_FORBID, BaseModel, ConfigDict, Field
from jaguarete.core import EmbeddingModelMetadata, Embeddings
from jaguarete.core.awel.flow import Parameter, ResourceCategory, register_resource
from jaguarete.core.interface.parameter import EmbeddingDeployModelParameters
from jaguarete.model.adapter.base import register_embedding_adapter
from jaguarete.model.adapter.embed_metadata import (
    EMBED_COMMON_HF_BGE_MODELS,
    EMBED_COMMON_HF_JINA_MODELS,
    EMBED_COMMON_HF_QWEN_MODELS,
)
from jaguarete.util.i18n_utils import _
from jaguarete.util.tracer import JAGUARETE_TRACER_SPAN_ID, root_tracer
...
class HuggingFaceEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from jaguarete.rag.embedding import HuggingFaceEmbeddings
...
class HuggingFaceInstructEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from jaguarete.rag.embeddings import HuggingFaceInstructEmbeddings
...
class HuggingFaceBgeEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from jaguarete.rag.embeddings import HuggingFaceBgeEmbeddings
...
class OpenAPIEmbeddings(BaseModel, Embeddings):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from jaguarete.rag.embedding import OpenAPIEmbeddings
        ...
        Using Jaguarete APIServer's embedding API:
        To use the Jaguarete APIServer's embedding API, you should deploy Jaguarete according
        to the `Cluster Deploy
        <https://docs.jaguarete.site/docs/installation/model_service/cluster>`_.

        A simple example:
        1. Deploy Model Cluster with following command:
        .. code-block:: bash

            jaguarete start controller --port 8000

        2. Deploy Embedding Model Worker with following command:
        .. code-block:: bash

            jaguarete start worker --model_name text2vec \
        ...
        .. code-block:: bash
            ...
            jaguarete start apiserver --controller_addr http://127.0.0.1:8000 \
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        if self.pass_trace_id and current_span_id:
            ...
            headers[JAGUARETE_TRACER_SPAN_ID] = current_span_id
