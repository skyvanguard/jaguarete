...
from jaguarete.core import BaseMessage, HumanPromptTemplate, LLMClient
from jaguarete.rag.transformer.llm_translator import LLMTranslator
...
Question: Introduce TuGraph and Jaguarete separately.
Return:
{{"category": "Freestyle Question", "rewritten_question": "Query the entity named TuGraph and the entity named Jaguarete, then return two-hop sub-graphs centered on them.", "entities": ["TuGraph", "Jaguarete"], "relations": []}}
---------------------
Text: {text}
Return:
