...
from jaguarete.core import Embeddings, LLMClient
from jaguarete.core.interface.evaluation import (
...
from jaguarete.core.interface.operators.retriever import RetrieverOperator
from jaguarete.util.similarity_util import calculate_cosine_similarity
...
class RetrieverEvaluator(Evaluator):
    ...
    Examples:
        .. code-block:: python
            ...
            import os
            import asyncio
            from jaguarete.rag.operators import (
                EmbeddingRetrieverOperator,
                RetrieverEvaluatorOperator,
            )
            from jaguarete.rag.evaluation import (
                RetrieverEvaluator,
                RetrieverSimilarityMetric,
            )
            from jaguarete.rag.embedding import DefaultEmbeddingFactory
            # These imports require jaguarete_ext and jaguarete_serve packages:
            # from jaguarete_ext.storage.vector_store.chroma_store import ChromaVectorConfig
            # from jaguarete_serve.rag.connector import VectorStoreConnector
            from jaguarete.configs.model_config import MODEL_PATH, PILOT_PATH
    ...
    async def evaluate(
        ...
        **kwargs,
        ...
        from jaguarete.core.awel import DAG, IteratorTrigger, MapOperator
